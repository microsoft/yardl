classdef TestBenchmarkInt256x256Writer < test_model.BenchmarkInt256x256WriterBase
  ...
  methods
    function obj = TestBenchmarkInt256x256Writer(testCase, writer, create_reader)
      obj.writer_ = writer;
      obj.create_reader_ = create_reader;
      obj.mock_writer_ = test_model.testing.MockBenchmarkInt256x256Writer(testCase);
  ...
  methods (Access=protected)
    function write_int256x256_(obj, value)
      obj.writer_.write_int256x256(value);
      obj.mock_writer_.expect_write_int256x256_(value);
    end
