...
classdef TestStreamsOfAliasedUnionsWriter < test_model.StreamsOfAliasedUnionsWriterBase
  ...
  methods
    function self = TestStreamsOfAliasedUnionsWriter(testCase, format, create_writer, create_reader)
      self.filename_ = tempname();
      self.format_ = format;
      self.writer_ = create_writer(self.filename_);
      self.create_reader_ = create_reader;
      self.mock_writer_ = test_model.testing.MockStreamsOfAliasedUnionsWriter(testCase);
    ...
    function end_int_or_simple_record(self)
      end_int_or_simple_record@test_model.StreamsOfAliasedUnionsWriterBase(self);
      self.writer_.end_int_or_simple_record();
    end

    function end_nullable_int_or_simple_record(self)
      end_nullable_int_or_simple_record@test_model.StreamsOfAliasedUnionsWriterBase(self);
