...
def _mk_get_dtype():
    ...
    dtype_map.setdefault(basic_types.GenericNullableUnion2, lambda type_args: np.dtype(np.object_))
    dtype_map.setdefault(basic_types.RecordWithString, np.dtype([('i', np.dtype(np.object_))], align=True))
    dtype_map.setdefault(basic_types.RecordWithUnions, np.dtype([('null_or_int_or_string', np.dtype(np.object_)), ('date_or_datetime', np.dtype(np.object_)), ('null_or_fruits_or_days_of_week', np.dtype(np.object_)), ('record_or_int', np.dtype(np.object_))], align=True))
    ...
    dtype_map.setdefault(basic_types.RecordWithStringOrInt32, np.dtype(np.object_))
    dtype_map.setdefault(basic_types.RecordWithStringOrInt32.RecordWithString, get_dtype(basic_types.RecordWithString))
    dtype_map.setdefault(basic_types.RecordWithStringOrInt32.Int32, np.dtype(np.int32))
