...
void ProtocolWithChangesWriterBaseInvalidState(uint8_t attempted, [[maybe_unused]] bool end, uint8_t current) {
  ...
  case 99: expected_method = "WriteAddedOptional()"; break;
  case 100: expected_method = "WriteAddedMap()"; break;
  case 101: expected_method = "WriteAddedRecordStream() or EndAddedRecordStream()"; break;
  }
  ...
  case 99: attempted_method = "WriteAddedOptional()"; break;
  case 100: attempted_method = "WriteAddedMap()"; break;
  case 101: attempted_method = end ? "EndAddedRecordStream()" : "WriteAddedRecordStream()"; break;
  case 102: attempted_method = "Close()"; break;
  }
...
void ProtocolWithChangesReaderBaseInvalidState(uint8_t attempted, uint8_t current) {
  auto f = [](uint8_t i) -> std::string {
    ...
    case 99: return "ReadAddedOptional()";
    case 100: return "ReadAddedMap()";
    case 101: return "ReadAddedRecordStream()";
    case 102: return "Close()";
