classdef RecordWithNDArrays < handle
  ...
  methods
    function obj = RecordWithNDArrays(ints, fixed_simple_record_array, fixed_record_with_vlens_array)
      if nargin > 0
        obj.ints = ints;
        obj.fixed_simple_record_array = fixed_simple_record_array;
        obj.fixed_record_with_vlens_array = fixed_record_with_vlens_array;
      else
        obj.ints = int32.empty(0, 0);
        obj.fixed_simple_record_array = test_model.SimpleRecord.empty(0, 0);
        obj.fixed_record_with_vlens_array = test_model.RecordWithVlens.empty(0, 0);
      end
    end
