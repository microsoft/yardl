...
class ProtocolWithChangesWriter : public evo_test::ProtocolWithChangesWriterBase, yardl::binary::BinaryWriter {
  ...
  void WriteStreamIntToStringToFloatImpl(std::vector<int32_t> const& values) override;
  ...
  void WriteStreamUnionReorderedImpl(std::vector<std::variant<int32_t, std::string>> const& values) override;
...
class ProtocolWithChangesReader : public evo_test::ProtocolWithChangesReaderBase, yardl::binary::BinaryReader {
  ...
  bool ReadStreamIntToStringToFloatImpl(std::vector<int32_t>& values) override;
  ...
  bool ReadStreamUnionReorderedImpl(std::vector<std::variant<int32_t, std::string>>& values) override;
...
class ProtocolWithChangesIndexedReader : public evo_test::ProtocolWithChangesIndexedReaderBase, yardl::binary::BinaryIndexedReader {
  ...
  bool ReadStreamIntToStringToFloatImpl(int32_t& value) override;
  bool ReadStreamIntToStringToFloatImpl(std::vector<int32_t>& values) override;
  bool ReadStreamIntToStringToFloatImpl(int32_t& value, size_t idx) override;
  bool ReadStreamIntToStringToFloatImpl(std::vector<int32_t>& values, size_t idx) override;
  ...
  bool ReadStreamUnionReorderedImpl(std::variant<int32_t, std::string>& value) override;
  bool ReadStreamUnionReorderedImpl(std::vector<std::variant<int32_t, std::string>>& values) override;
  bool ReadStreamUnionReorderedImpl(std::variant<int32_t, std::string>& value, size_t idx) override;
  bool ReadStreamUnionReorderedImpl(std::vector<std::variant<int32_t, std::string>>& values, size_t idx) override;
  ...
  bool ReadGenericRecordStreamImpl(evo_test::GenericRecord<int32_t, std::string>& value) override;
  bool ReadGenericRecordStreamImpl(std::vector<evo_test::GenericRecord<int32_t, std::string>>& values) override;
  bool ReadGenericRecordStreamImpl(evo_test::GenericRecord<int32_t, std::string>& value, size_t idx) override;
  bool ReadGenericRecordStreamImpl(std::vector<evo_test::GenericRecord<int32_t, std::string>>& values, size_t idx) override;
