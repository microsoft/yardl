...
void ProtocolWithChangesWriterBaseInvalidState(uint8_t attempted, [[maybe_unused]] bool end, uint8_t current) {
  ...
  case 94: expected_method = "WriteAddedRecordStream() or EndAddedRecordStream()"; break;
  }
  ...
  case 94: attempted_method = end ? "EndAddedRecordStream()" : "WriteAddedRecordStream()"; break;
  case 95: attempted_method = "Close()"; break;
  }
...
void ProtocolWithChangesReaderBaseInvalidState(uint8_t attempted, uint8_t current) {
  auto f = [](uint8_t i) -> std::string {
    ...
    case 94: return "ReadAddedRecordStream()";
    case 95: return "Close()";
...
void ProtocolWithChangesWriterBase::EndAddedRecordStream() {
  if (unlikely(state_ != 94)) {
    ProtocolWithChangesWriterBaseInvalidState(94, true, state_);
  }
