...
// Binary indexed writer for the ProtocolWithChanges protocol.
class ProtocolWithChangesIndexedWriter : public evo_test::ProtocolWithChangesWriterBase, yardl::binary::BinaryIndexedWriter {
  public:
  ProtocolWithChangesIndexedWriter(std::ostream& stream, Version version = Version::Current)
      : yardl::binary::BinaryIndexedWriter(stream, evo_test::ProtocolWithChangesWriterBase::SchemaFromVersion(version)), version_(version) {}

  ProtocolWithChangesIndexedWriter(std::string file_name, Version version = Version::Current)
      : yardl::binary::BinaryIndexedWriter(file_name, evo_test::ProtocolWithChangesWriterBase::SchemaFromVersion(version)), version_(version) {}
...
// Binary indexed reader for the ProtocolWithChanges protocol.
class ProtocolWithChangesIndexedReader : public evo_test::ProtocolWithChangesIndexedReaderBase, yardl::binary::BinaryIndexedReader {
  public:
  ProtocolWithChangesIndexedReader(std::istream& stream)
      : yardl::binary::BinaryIndexedReader(stream), version_(evo_test::ProtocolWithChangesIndexedReaderBase::VersionFromSchema(schema_read_)) {}

  ProtocolWithChangesIndexedReader(std::string file_name)
      : yardl::binary::BinaryIndexedReader(file_name), version_(evo_test::ProtocolWithChangesIndexedReaderBase::VersionFromSchema(schema_read_)) {}
  ...
  bool ReadStreamIntToStringToFloatImpl(std::string& value) override;
  bool ReadStreamIntToStringToFloatImpl(std::vector<std::string>& values) override;
  bool ReadStreamIntToStringToFloatImpl(std::string& value, size_t idx) override;
  bool ReadStreamIntToStringToFloatImpl(std::vector<std::string>& values, size_t idx) override;
  size_t CountStreamIntToStringToFloatImpl() override;
  void ReadVectorIntToStringToFloatImpl(std::vector<std::string>& value) override;
  void ReadIntFloatUnionReorderedImpl(std::variant<float, int32_t>& value) override;
  void ReadVectorUnionReorderedImpl(std::vector<std::variant<float, int32_t>>& value) override;
  bool ReadStreamUnionReorderedImpl(std::variant<std::string, int32_t>& value) override;
  bool ReadStreamUnionReorderedImpl(std::vector<std::variant<std::string, int32_t>>& values) override;
  bool ReadStreamUnionReorderedImpl(std::variant<std::string, int32_t>& value, size_t idx) override;
  bool ReadStreamUnionReorderedImpl(std::vector<std::variant<std::string, int32_t>>& values, size_t idx) override;
  size_t CountStreamUnionReorderedImpl() override;
  bool ReadIntToUnionStreamImpl(int32_t& value) override;
  bool ReadIntToUnionStreamImpl(std::vector<int32_t>& values) override;
  bool ReadIntToUnionStreamImpl(int32_t& value, size_t idx) override;
  bool ReadIntToUnionStreamImpl(std::vector<int32_t>& values, size_t idx) override;
  size_t CountIntToUnionStreamImpl() override;
  bool ReadUnionStreamTypeChangeImpl(std::variant<int32_t, bool>& value) override;
  bool ReadUnionStreamTypeChangeImpl(std::vector<std::variant<int32_t, bool>>& values) override;
  bool ReadUnionStreamTypeChangeImpl(std::variant<int32_t, bool>& value, size_t idx) override;
  bool ReadUnionStreamTypeChangeImpl(std::vector<std::variant<int32_t, bool>>& values, size_t idx) override;
  size_t CountUnionStreamTypeChangeImpl() override;
  bool ReadStreamOfAliasTypeChangeImpl(evo_test::StreamItem& value) override;
  bool ReadStreamOfAliasTypeChangeImpl(std::vector<evo_test::StreamItem>& values) override;
  bool ReadStreamOfAliasTypeChangeImpl(evo_test::StreamItem& value, size_t idx) override;
  bool ReadStreamOfAliasTypeChangeImpl(std::vector<evo_test::StreamItem>& values, size_t idx) override;
  size_t CountStreamOfAliasTypeChangeImpl() override;
  void ReadRlinkImpl(evo_test::RLink& value) override;
  void ReadRlinkRXImpl(evo_test::RX& value) override;
  void ReadRlinkRYImpl(evo_test::RY& value) override;
  void ReadRlinkRZImpl(evo_test::RZ& value) override;
  ...
  bool ReadGenericRecordStreamImpl(evo_test::AliasedClosedGenericRecord& value) override;
  bool ReadGenericRecordStreamImpl(std::vector<evo_test::AliasedClosedGenericRecord>& values) override;
  bool ReadGenericRecordStreamImpl(evo_test::AliasedClosedGenericRecord& value, size_t idx) override;
  bool ReadGenericRecordStreamImpl(std::vector<evo_test::AliasedClosedGenericRecord>& values, size_t idx) override;
  size_t CountGenericRecordStreamImpl() override;
  bool ReadGenericParentRecordStreamImpl(evo_test::GenericParentRecord<int32_t>& value) override;
  bool ReadGenericParentRecordStreamImpl(std::vector<evo_test::GenericParentRecord<int32_t>>& values) override;
  bool ReadGenericParentRecordStreamImpl(evo_test::GenericParentRecord<int32_t>& value, size_t idx) override;
  bool ReadGenericParentRecordStreamImpl(std::vector<evo_test::GenericParentRecord<int32_t>>& values, size_t idx) override;
  size_t CountGenericParentRecordStreamImpl() override;
  void ReadVectorRecordWithChangesImpl(std::vector<evo_test::RecordWithChanges>& value) override;
  bool ReadStreamedRecordWithChangesImpl(evo_test::RecordWithChanges& value) override;
  bool ReadStreamedRecordWithChangesImpl(std::vector<evo_test::RecordWithChanges>& values) override;
  bool ReadStreamedRecordWithChangesImpl(evo_test::RecordWithChanges& value, size_t idx) override;
  bool ReadStreamedRecordWithChangesImpl(std::vector<evo_test::RecordWithChanges>& values, size_t idx) override;
  size_t CountStreamedRecordWithChangesImpl() override;
  void ReadAddedOptionalImpl(std::optional<evo_test::RecordWithChanges>& value) override;
  void ReadAddedMapImpl(std::unordered_map<std::string, std::string>& value) override;
  bool ReadAddedRecordStreamImpl(evo_test::RecordWithChanges& value) override;
  bool ReadAddedRecordStreamImpl(std::vector<evo_test::RecordWithChanges>& values) override;
  bool ReadAddedRecordStreamImpl(evo_test::RecordWithChanges& value, size_t idx) override;
  bool ReadAddedRecordStreamImpl(std::vector<evo_test::RecordWithChanges>& values, size_t idx) override;
  size_t CountAddedRecordStreamImpl() override;
  void CloseImpl() override;
...
// Binary indexed writer for the UnusedProtocol protocol.
class UnusedProtocolIndexedWriter : public evo_test::UnusedProtocolWriterBase, yardl::binary::BinaryIndexedWriter {
  public:
  UnusedProtocolIndexedWriter(std::ostream& stream, Version version = Version::Current)
      : yardl::binary::BinaryIndexedWriter(stream, evo_test::UnusedProtocolWriterBase::SchemaFromVersion(version)), version_(version) {}

  UnusedProtocolIndexedWriter(std::string file_name, Version version = Version::Current)
      : yardl::binary::BinaryIndexedWriter(file_name, evo_test::UnusedProtocolWriterBase::SchemaFromVersion(version)), version_(version) {}
...
// Binary indexed reader for the UnusedProtocol protocol.
class UnusedProtocolIndexedReader : public evo_test::UnusedProtocolIndexedReaderBase, yardl::binary::BinaryIndexedReader {
  public:
  UnusedProtocolIndexedReader(std::istream& stream)
      : yardl::binary::BinaryIndexedReader(stream), version_(evo_test::UnusedProtocolIndexedReaderBase::VersionFromSchema(schema_read_)) {}

  UnusedProtocolIndexedReader(std::string file_name)
      : yardl::binary::BinaryIndexedReader(file_name), version_(evo_test::UnusedProtocolIndexedReaderBase::VersionFromSchema(schema_read_)) {}
  ...
  bool ReadRecordsImpl(evo_test::UnchangedRecord& value) override;
  bool ReadRecordsImpl(std::vector<evo_test::UnchangedRecord>& values) override;
  bool ReadRecordsImpl(evo_test::UnchangedRecord& value, size_t idx) override;
  bool ReadRecordsImpl(std::vector<evo_test::UnchangedRecord>& values, size_t idx) override;
  size_t CountRecordsImpl() override;
  void CloseImpl() override;
