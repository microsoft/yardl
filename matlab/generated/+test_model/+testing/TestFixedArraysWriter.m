...
classdef TestFixedArraysWriter < test_model.FixedArraysWriterBase
  ...
  methods
    function self = TestFixedArraysWriter(testCase, format, create_writer, create_reader)
      self.filename_ = tempname();
      self.format_ = format;
      self.writer_ = create_writer(self.filename_);
      self.create_reader_ = create_reader;
      self.mock_writer_ = test_model.testing.MockFixedArraysWriter(testCase);
  ...
  methods (Access=protected)
    ...
    function write_fixed_simple_record_array_(self, value)
      self.writer_.write_fixed_simple_record_array(value);
      self.mock_writer_.expect_write_fixed_simple_record_array_(value);
    end

    function write_fixed_record_with_vlens_array_(self, value)
      self.writer_.write_fixed_record_with_vlens_array(value);
      self.mock_writer_.expect_write_fixed_record_with_vlens_array_(value);
    end

    function write_record_with_fixed_arrays_(self, value)
      self.writer_.write_record_with_fixed_arrays(value);
      self.mock_writer_.expect_write_record_with_fixed_arrays_(value);
    end
