...
classdef MockDynamicNDArraysWriter < matlab.mixin.Copyable & test_model.DynamicNDArraysWriterBase
  properties
    testCase_
    write_ints_written
  ...
  methods
    function obj = MockDynamicNDArraysWriter(testCase)
      ...
      obj.write_record_with_dynamic_nd_arrays_written = yardl.None;
    end
    ...
    function expect_write_record_with_dynamic_nd_arrays_(obj, value)
      if obj.write_record_with_dynamic_nd_arrays_written.has_value()
        last_dim = ndims(value);
        obj.write_record_with_dynamic_nd_arrays_written = yardl.Optional(cat(last_dim, obj.write_record_with_dynamic_nd_arrays_written.value, value));
      else
        obj.write_record_with_dynamic_nd_arrays_written = yardl.Optional(value);
      end
    end
    ...
    function verify(obj)
      ...
      obj.testCase_.verifyEqual(obj.write_record_with_dynamic_nd_arrays_written, yardl.None, "Expected call to write_record_with_dynamic_nd_arrays_ was not received");
    end
  end
  ...
  methods (Access=protected)
    ...
    function write_record_with_dynamic_nd_arrays_(obj, value)
      obj.testCase_.verifyTrue(obj.write_record_with_dynamic_nd_arrays_written.has_value(), "Unexpected call to write_record_with_dynamic_nd_arrays_");
      expected = obj.write_record_with_dynamic_nd_arrays_written.value;
