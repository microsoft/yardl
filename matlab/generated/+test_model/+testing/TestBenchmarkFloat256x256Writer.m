...
classdef TestBenchmarkFloat256x256Writer < test_model.BenchmarkFloat256x256WriterBase
  ...
  methods
    function self = TestBenchmarkFloat256x256Writer(testCase, format, create_writer, create_reader)
      self.filename_ = tempname();
      self.format_ = format;
      self.writer_ = create_writer(self.filename_);
      self.create_reader_ = create_reader;
      self.mock_writer_ = test_model.testing.MockBenchmarkFloat256x256Writer(testCase);
    ...
    function end_float256x256(self)
      end_float256x256@test_model.BenchmarkFloat256x256WriterBase(self);
      self.writer_.end_float256x256();
    end
  ...
  methods (Access=protected)
    function write_float256x256_(self, value)
      self.writer_.write_float256x256(value);
      self.mock_writer_.expect_write_float256x256_(value);
    end
