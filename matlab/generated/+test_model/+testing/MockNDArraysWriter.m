classdef MockNDArraysWriter < test_model.NDArraysWriterBase
  properties
    testCase_
    write_ints_written
  ...
  methods
    function obj = MockNDArraysWriter(testCase)
    ...
    function expect_write_record_with_nd_arrays_(obj, value)
      obj.write_record_with_nd_arrays_written(end+1) = Node(value);
    end
  ...
  methods (Access=protected)
    ...
    function write_record_with_nd_arrays_(obj, value)
      ...
      obj.write_record_with_nd_arrays_written = obj.write_record_with_nd_arrays_written(2:end);
    end
