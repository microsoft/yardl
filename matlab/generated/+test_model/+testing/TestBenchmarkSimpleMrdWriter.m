...
classdef TestBenchmarkSimpleMrdWriter < test_model.BenchmarkSimpleMrdWriterBase
  ...
  methods
    function self = TestBenchmarkSimpleMrdWriter(testCase, format, create_writer, create_reader)
      self.filename_ = tempname();
      self.format_ = format;
      self.writer_ = create_writer(self.filename_);
      self.create_reader_ = create_reader;
      self.mock_writer_ = test_model.testing.MockBenchmarkSimpleMrdWriter(testCase);
    ...
    function end_data(self)
      end_data@test_model.BenchmarkSimpleMrdWriterBase(self);
      self.writer_.end_data();
    end
  ...
  methods (Access=protected)
    function write_data_(self, value)
      self.writer_.write_data(value);
      self.mock_writer_.expect_write_data_(value);
    end
