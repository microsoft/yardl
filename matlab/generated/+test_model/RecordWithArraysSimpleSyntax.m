...
classdef RecordWithArraysSimpleSyntax < handle
  ...
  methods
    function self = RecordWithArraysSimpleSyntax(kwargs)
      arguments
        kwargs.default_array = int32.empty();
        kwargs.default_array_with_empty_dimension = int32.empty();
        kwargs.rank_1_array = int32.empty(0);
        kwargs.rank_2_array = int32.empty(0, 0);
        kwargs.rank_2_array_with_named_dimensions = int32.empty(0, 0);
