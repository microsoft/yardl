...
classdef TestNestedRecordsWriter < test_model.NestedRecordsWriterBase
  ...
  methods
    function self = TestNestedRecordsWriter(testCase, format, create_writer, create_reader)
      self.filename_ = tempname();
      self.format_ = format;
      self.writer_ = create_writer(self.filename_);
      self.create_reader_ = create_reader;
      self.mock_writer_ = test_model.testing.MockNestedRecordsWriter(testCase);
  ...
  methods (Access=protected)
    function write_tuple_with_records_(self, value)
      self.writer_.write_tuple_with_records(value);
      self.mock_writer_.expect_write_tuple_with_records_(value);
    end
