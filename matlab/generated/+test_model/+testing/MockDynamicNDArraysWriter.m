...
classdef MockDynamicNDArraysWriter < matlab.mixin.Copyable & test_model.DynamicNDArraysWriterBase
  ...
  methods
    ...
    function expect_write_record_with_dynamic_nd_arrays_(obj, value)
      if isempty(obj.write_record_with_dynamic_nd_arrays_written)
        obj.write_record_with_dynamic_nd_arrays_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_record_with_dynamic_nd_arrays_written = Node(cat(last_dim, obj.write_record_with_dynamic_nd_arrays_written(1).value, value));
      end
    end
