...
class ProtocolWithChangesWriterBase {
  ...
  // Ordinal 14.
  void WriteComplexFloatToComplexDouble(std::complex<float> const& value);
  ...
  // Ordinal 94.
  void WriteGenericUnionToReversed(evo_test::GenericUnion<evo_test::GenericRecord<int32_t, std::string>, float> const& value);
  ...
  virtual void WriteComplexFloatToComplexDoubleImpl(std::complex<float> const& value) = 0;
  ...
  virtual void WriteGenericUnionToReversedImpl(evo_test::GenericUnion<evo_test::GenericRecord<int32_t, std::string>, float> const& value) = 0;
...
class ProtocolWithChangesReaderBase {
  ...
  // Ordinal 14.
  void ReadComplexFloatToComplexDouble(std::complex<float>& value);
  ...
  // Ordinal 94.
  void ReadGenericUnionToReversed(evo_test::GenericUnion<evo_test::GenericRecord<int32_t, std::string>, float>& value);
  ...
  virtual void ReadComplexFloatToComplexDoubleImpl(std::complex<float>& value) = 0;
  ...
  virtual void ReadGenericUnionToReversedImpl(evo_test::GenericUnion<evo_test::GenericRecord<int32_t, std::string>, float>& value) = 0;
...
class ProtocolWithChangesIndexedReaderBase : public ProtocolWithChangesReaderBase {
  ...
  using ProtocolWithChangesReaderBase::ReadIntToUnionStreamImpl;
  ...
  using ProtocolWithChangesReaderBase::ReadUnionStreamTypeChangeImpl;
  ...
  using ProtocolWithChangesReaderBase::ReadAddedRecordStreamImpl;
  ...
  using ProtocolWithChangesReaderBase::ReadAddedUnionStreamImpl;
