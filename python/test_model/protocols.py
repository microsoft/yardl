...
class BenchmarkFloat256x256WriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"BenchmarkFloat256x256","sequence":[{"name":"float256x256","type":{"stream":{"items":{"array":{"items":"float32","dimensions":[{"length":256},{"length":256}]}}}}}]},"types":null}"""
...
class BenchmarkFloatVlenWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"BenchmarkFloatVlen","sequence":[{"name":"floatArray","type":{"stream":{"items":{"array":{"items":"float32","dimensions":2}}}}}]},"types":null}"""
...
class BenchmarkSmallRecordWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"BenchmarkSmallRecord","sequence":[{"name":"smallRecord","type":{"stream":{"items":"TestModel.SmallBenchmarkRecord"}}}]},"types":[{"name":"SmallBenchmarkRecord","fields":[{"name":"a","type":"float64"},{"name":"b","type":"float32"},{"name":"c","type":"float32"}]}]}"""
...
class BenchmarkSmallRecordWithOptionalsWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"BenchmarkSmallRecordWithOptionals","sequence":[{"name":"smallRecord","type":{"stream":{"items":"TestModel.SimpleEncodingCounters"}}}]},"types":[{"name":"SimpleEncodingCounters","fields":[{"name":"e1","type":[null,"uint32"]},{"name":"e2","type":[null,"uint32"]},{"name":"slice","type":[null,"uint32"]},{"name":"repetition","type":[null,"uint32"]}]}]}"""
...
class BenchmarkSimpleMrdWriterBase(abc.ABC):
    ...
    def write_data(self, value: collections.abc.Iterable[SimpleAcquisition | Image[yardl.Float32]]) -> None:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
...
class BenchmarkSimpleMrdReaderBase(abc.ABC):
    ...
    def read_data(self) -> collections.abc.Iterable[SimpleAcquisition | Image[yardl.Float32]]:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
...
class NestedRecordsWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"NestedRecords","sequence":[{"name":"tupleWithRecords","type":"TestModel.TupleWithRecords"}]},"types":[{"name":"SimpleRecord","fields":[{"name":"x","type":"int32"},{"name":"y","type":"int32"},{"name":"z","type":"int32"}]},{"name":"TupleWithRecords","fields":[{"name":"a","type":"TestModel.SimpleRecord"},{"name":"b","type":"TestModel.SimpleRecord"}]}]}"""
...
class StringsWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"Strings","sequence":[{"name":"singleString","type":"string"},{"name":"recWithString","type":"TestModel.RecordWithStrings"}]},"types":[{"name":"RecordWithStrings","fields":[{"name":"a","type":"string"},{"name":"b","type":"string"}]}]}"""
...
class OptionalVectorsWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"OptionalVectors","sequence":[{"name":"recordWithOptionalVector","type":"TestModel.RecordWithOptionalVector"}]},"types":[{"name":"RecordWithOptionalVector","fields":[{"name":"optionalVector","type":[null,{"vector":{"items":"int32"}}]}]}]}"""
...
class MapsWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"Maps","sequence":[{"name":"stringToInt","type":{"map":{"keys":"string","values":"int32"}}},{"name":"stringToUnion","type":{"map":{"keys":"string","values":[{"label":"string","type":"string"},{"label":"int32","type":"int32"}]}}},{"name":"aliasedGeneric","type":{"name":"TestModel.AliasedMap","typeArguments":["string","int32"]}}]},"types":[{"name":"AliasedMap","typeParameters":["K","V"],"type":{"map":{"keys":"K","values":"V"}}}]}"""
    ...
    def write_string_to_union(self, value: dict[str, str | yardl.Int32]) -> None:
        """Ordinal 1"""
        if self._state != 1:
            self._raise_unexpected_state(1)
...
class MapsReaderBase(abc.ABC):
    ...
    def read_string_to_union(self) -> dict[str, str | yardl.Int32]:
        """Ordinal 1"""
        if self._state != 2:
            self._raise_unexpected_state(2)
...
class UnionsWriterBase(abc.ABC):
    ...
    def write_int_or_simple_record(self, value: yardl.Int32 | SimpleRecord) -> None:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
    ...
    def write_int_or_record_with_vlens(self, value: yardl.Int32 | RecordWithVlens) -> None:
        """Ordinal 1"""
        if self._state != 1:
            self._raise_unexpected_state(1)
    ...
    def write_monosotate_or_int_or_simple_record(self, value: yardl.Int32 | SimpleRecord | None) -> None:
        """Ordinal 2"""
        if self._state != 2:
            self._raise_unexpected_state(2)
...
class UnionsReaderBase(abc.ABC):
    ...
    def read_int_or_simple_record(self) -> yardl.Int32 | SimpleRecord:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
    ...
    def read_int_or_record_with_vlens(self) -> yardl.Int32 | RecordWithVlens:
        """Ordinal 1"""
        if self._state != 2:
            self._raise_unexpected_state(2)
    ...
    def read_monosotate_or_int_or_simple_record(self) -> yardl.Int32 | SimpleRecord | None:
        """Ordinal 2"""
        if self._state != 4:
            self._raise_unexpected_state(4)
...
class StreamsOfUnionsWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"StreamsOfUnions","sequence":[{"name":"intOrSimpleRecord","type":{"stream":{"items":[{"label":"int32","type":"int32"},{"label":"SimpleRecord","type":"TestModel.SimpleRecord"}]}}},{"name":"nullableIntOrSimpleRecord","type":{"stream":{"items":[null,{"label":"int32","type":"int32"},{"label":"SimpleRecord","type":"TestModel.SimpleRecord"}]}}}]},"types":[{"name":"SimpleRecord","fields":[{"name":"x","type":"int32"},{"name":"y","type":"int32"},{"name":"z","type":"int32"}]}]}"""
    ...
    def write_int_or_simple_record(self, value: collections.abc.Iterable[yardl.Int32 | SimpleRecord]) -> None:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
    ...
    def write_nullable_int_or_simple_record(self, value: collections.abc.Iterable[yardl.Int32 | SimpleRecord | None]) -> None:
        """Ordinal 1"""
        if self._state != 1:
            self._raise_unexpected_state(1)
...
class StreamsOfUnionsReaderBase(abc.ABC):
    ...
    def read_int_or_simple_record(self) -> collections.abc.Iterable[yardl.Int32 | SimpleRecord]:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
    ...
    def read_nullable_int_or_simple_record(self) -> collections.abc.Iterable[yardl.Int32 | SimpleRecord | None]:
        """Ordinal 1"""
        if self._state != 2:
            self._raise_unexpected_state(2)
...
class EnumsWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"Enums","sequence":[{"name":"single","type":"TestModel.Fruits"},{"name":"vec","type":{"vector":{"items":"TestModel.Fruits"}}},{"name":"size","type":"TestModel.SizeBasedEnum"}]},"types":[{"name":"Fruits","values":[{"symbol":"apple","value":0},{"symbol":"banana","value":1},{"symbol":"pear","value":2}]},{"name":"SizeBasedEnum","base":"size","values":[{"symbol":"a","value":0},{"symbol":"b","value":1},{"symbol":"c","value":2}]}]}"""
...
class StateTestWriterBase(abc.ABC):
    ...
    schema = """{"protocol":{"name":"StateTest","sequence":[{"name":"anInt","type":"int32"},{"name":"aStream","type":{"stream":{"items":"int32"}}},{"name":"anotherInt","type":"int32"}]},"types":null}"""
...
class SimpleGenericsWriterBase(abc.ABC):
    ...
    def write_float_image(self, value: Image[yardl.Float32]) -> None:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
    ...
    def write_int_image(self, value: Image[yardl.Int32]) -> None:
        """Ordinal 1"""
        if self._state != 1:
            self._raise_unexpected_state(1)
    ...
    def write_int_image_alternate_syntax(self, value: Image[yardl.Int32]) -> None:
        """Ordinal 2"""
        if self._state != 2:
            self._raise_unexpected_state(2)
    ...
    def write_string_image(self, value: Image[str]) -> None:
        """Ordinal 3"""
        if self._state != 3:
            self._raise_unexpected_state(3)
    ...
    def write_stream_of_type_variants(self, value: collections.abc.Iterable[Image[yardl.Float32] | Image[yardl.Float64]]) -> None:
        """Ordinal 8"""
        if self._state != 8:
            self._raise_unexpected_state(8)
...
class SimpleGenericsReaderBase(abc.ABC):
    ...
    def read_float_image(self) -> Image[yardl.Float32]:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
    ...
    def read_int_image(self) -> Image[yardl.Int32]:
        """Ordinal 1"""
        if self._state != 2:
            self._raise_unexpected_state(2)
    ...
    def read_int_image_alternate_syntax(self) -> Image[yardl.Int32]:
        """Ordinal 2"""
        if self._state != 4:
            self._raise_unexpected_state(4)
    ...
    def read_string_image(self) -> Image[str]:
        """Ordinal 3"""
        if self._state != 6:
            self._raise_unexpected_state(6)
    ...
    def read_stream_of_type_variants(self) -> collections.abc.Iterable[Image[yardl.Float32] | Image[yardl.Float64]]:
        """Ordinal 8"""
        if self._state != 16:
...
class AdvancedGenericsWriterBase(abc.ABC):
    ...
    def write_int_image_image(self, value: Image[Image[yardl.Float32]]) -> None:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
    ...
    def write_generic_record_1(self, value: GenericRecord[yardl.Int32, str]) -> None:
        """Ordinal 1"""
        if self._state != 1:
            self._raise_unexpected_state(1)
...
class AdvancedGenericsReaderBase(abc.ABC):
    ...
    def read_int_image_image(self) -> Image[Image[yardl.Float32]]:
        """Ordinal 0"""
        if self._state != 0:
            self._raise_unexpected_state(0)
    ...
    def read_generic_record_1(self) -> GenericRecord[yardl.Int32, str]:
        """Ordinal 1"""
        if self._state != 2:
            self._raise_unexpected_state(2)
