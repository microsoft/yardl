...
class ProtocolWithChangesWriter : public evo_test::ProtocolWithChangesWriterBase, yardl::binary::BinaryWriter {
  ...
  void WriteStreamIntToStringToFloatImpl(std::vector<float> const& values) override;
  ...
  void WriteIntToUnionStreamImpl(std::vector<std::variant<std::string, int32_t>> const& values) override;
  void EndIntToUnionStreamImpl() override;
  void WriteUnionStreamTypeChangeImpl(std::variant<int32_t, float> const& value) override;
  void WriteUnionStreamTypeChangeImpl(std::vector<std::variant<int32_t, float>> const& values) override;
...
class ProtocolWithChangesReader : public evo_test::ProtocolWithChangesReaderBase, yardl::binary::BinaryReader {
  ...
  bool ReadStreamIntToStringToFloatImpl(std::vector<float>& values) override;
  ...
  bool ReadIntToUnionStreamImpl(std::vector<std::variant<std::string, int32_t>>& values) override;
  bool ReadUnionStreamTypeChangeImpl(std::variant<int32_t, float>& value) override;
  bool ReadUnionStreamTypeChangeImpl(std::vector<std::variant<int32_t, float>>& values) override;
...
class ProtocolWithChangesIndexedReader : public evo_test::ProtocolWithChangesIndexedReaderBase, yardl::binary::BinaryIndexedReader {
  ...
  bool ReadStreamIntToStringToFloatImpl(float& value) override;
  bool ReadStreamIntToStringToFloatImpl(std::vector<float>& values) override;
  bool ReadStreamIntToStringToFloatImpl(float& value, size_t idx) override;
  bool ReadStreamIntToStringToFloatImpl(std::vector<float>& values, size_t idx) override;
  ...
  bool ReadIntToUnionStreamImpl(std::variant<std::string, int32_t>& value) override;
  bool ReadIntToUnionStreamImpl(std::vector<std::variant<std::string, int32_t>>& values) override;
  bool ReadIntToUnionStreamImpl(std::variant<std::string, int32_t>& value, size_t idx) override;
  bool ReadIntToUnionStreamImpl(std::vector<std::variant<std::string, int32_t>>& values, size_t idx) override;
  size_t CountIntToUnionStreamImpl() override;
  bool ReadUnionStreamTypeChangeImpl(std::variant<int32_t, float>& value) override;
  bool ReadUnionStreamTypeChangeImpl(std::vector<std::variant<int32_t, float>>& values) override;
  bool ReadUnionStreamTypeChangeImpl(std::variant<int32_t, float>& value, size_t idx) override;
  bool ReadUnionStreamTypeChangeImpl(std::vector<std::variant<int32_t, float>>& values, size_t idx) override;
  ...
  bool ReadAddedUnionStreamImpl(std::variant<evo_test::RecordWithChanges, evo_test::RenamedRecord>& value) override;
  bool ReadAddedUnionStreamImpl(std::vector<std::variant<evo_test::RecordWithChanges, evo_test::RenamedRecord>>& values) override;
  bool ReadAddedUnionStreamImpl(std::variant<evo_test::RecordWithChanges, evo_test::RenamedRecord>& value, size_t idx) override;
  bool ReadAddedUnionStreamImpl(std::vector<std::variant<evo_test::RecordWithChanges, evo_test::RenamedRecord>>& values, size_t idx) override;
  size_t CountAddedUnionStreamImpl() override;
  void CloseImpl() override;
