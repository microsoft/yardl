    ...
    methods (Test)
        ...
        function testRecordWithEnumEquality(testCase)
            a = test_model.RecordWithEnums(enum=test_model.Fruits.APPLE, ...
                ...
                flags_2=0, ...
                rec=test_model.RecordWithNoDefaultEnum(enum=test_model.Fruits.PEAR));
