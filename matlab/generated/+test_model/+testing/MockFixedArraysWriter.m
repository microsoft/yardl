...
classdef MockFixedArraysWriter < matlab.mixin.Copyable & test_model.FixedArraysWriterBase
  ...
  methods
    ...
    function expect_write_fixed_simple_record_array_(obj, value)
      if isempty(obj.write_fixed_simple_record_array_written)
        obj.write_fixed_simple_record_array_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_fixed_simple_record_array_written = Node(cat(last_dim, obj.write_fixed_simple_record_array_written(1).value, value));
      end
    end

    function expect_write_fixed_record_with_vlens_array_(obj, value)
      if isempty(obj.write_fixed_record_with_vlens_array_written)
        obj.write_fixed_record_with_vlens_array_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_fixed_record_with_vlens_array_written = Node(cat(last_dim, obj.write_fixed_record_with_vlens_array_written(1).value, value));
      end
    end

    function expect_write_record_with_fixed_arrays_(obj, value)
      if isempty(obj.write_record_with_fixed_arrays_written)
        obj.write_record_with_fixed_arrays_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_record_with_fixed_arrays_written = Node(cat(last_dim, obj.write_record_with_fixed_arrays_written(1).value, value));
      end
    end

    function expect_write_named_array_(obj, value)
      if isempty(obj.write_named_array_written)
        obj.write_named_array_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_named_array_written = Node(cat(last_dim, obj.write_named_array_written(1).value, value));
      end
    end
