classdef GenericNullableUnion2 < yardl.Union
  methods (Static)
    function res = T1(value)
      res = basic_types.GenericNullableUnion2(1, value);
    end

    function res = T2(value)
      res = basic_types.GenericNullableUnion2(2, value);
    end

    function z = zeros(varargin)
      elem = basic_types.GenericNullableUnion2(0, yardl.None);
      if nargin == 0
        z = elem;
      elseif nargin == 1
        n = varargin{1};
