...
classdef (Abstract) NestedRecordsWriterBase < handle
  ...
  methods
    function self = NestedRecordsWriterBase()
      self.state_ = 0;
    end
    ...
    % Ordinal 0
    function write_tuple_with_records(self, value)
      if self.state_ ~= 0
        self.raise_unexpected_state_(0);
      end

      self.write_tuple_with_records_(value);
      self.state_ = 1;
    end
  end
  ...
  methods (Abstract, Access=protected)
    write_tuple_with_records_(self, value)
