...
classdef MockScalarOptionalsWriter < matlab.mixin.Copyable & test_model.ScalarOptionalsWriterBase
  ...
  methods
    ...
    function expect_write_optional_int_(obj, value)
      if isempty(obj.write_optional_int_written)
        obj.write_optional_int_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_optional_int_written = Node(cat(last_dim, obj.write_optional_int_written(1).value, value));
      end
    end

    function expect_write_optional_record_(obj, value)
      if isempty(obj.write_optional_record_written)
        obj.write_optional_record_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_optional_record_written = Node(cat(last_dim, obj.write_optional_record_written(1).value, value));
      end
    end

    function expect_write_record_with_optional_fields_(obj, value)
      if isempty(obj.write_record_with_optional_fields_written)
        obj.write_record_with_optional_fields_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_record_with_optional_fields_written = Node(cat(last_dim, obj.write_record_with_optional_fields_written(1).value, value));
      end
    end

    function expect_write_optional_record_with_optional_fields_(obj, value)
      if isempty(obj.write_optional_record_with_optional_fields_written)
        obj.write_optional_record_with_optional_fields_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_optional_record_with_optional_fields_written = Node(cat(last_dim, obj.write_optional_record_with_optional_fields_written(1).value, value));
      end
    end
