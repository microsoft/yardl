...
classdef TestNDArraysSingleDimensionWriter < test_model.NDArraysSingleDimensionWriterBase
  ...
  methods
    function self = TestNDArraysSingleDimensionWriter(testCase, format, create_writer, create_reader)
      self.filename_ = tempname();
      self.format_ = format;
      self.writer_ = create_writer(self.filename_);
      self.create_reader_ = create_reader;
      self.mock_writer_ = test_model.testing.MockNDArraysSingleDimensionWriter(testCase);
