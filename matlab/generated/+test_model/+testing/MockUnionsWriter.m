...
classdef MockUnionsWriter < matlab.mixin.Copyable & test_model.UnionsWriterBase
  ...
  methods
    ...
    function expect_write_int_or_record_with_vlens_(obj, value)
      if isempty(obj.write_int_or_record_with_vlens_written)
        obj.write_int_or_record_with_vlens_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_int_or_record_with_vlens_written = Node(cat(last_dim, obj.write_int_or_record_with_vlens_written(1).value, value));
      end
    end

    function expect_write_monosotate_or_int_or_simple_record_(obj, value)
      if isempty(obj.write_monosotate_or_int_or_simple_record_written)
        obj.write_monosotate_or_int_or_simple_record_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_monosotate_or_int_or_simple_record_written = Node(cat(last_dim, obj.write_monosotate_or_int_or_simple_record_written(1).value, value));
      end
    end

    function expect_write_record_with_unions_(obj, value)
      if isempty(obj.write_record_with_unions_written)
        obj.write_record_with_unions_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_record_with_unions_written = Node(cat(last_dim, obj.write_record_with_unions_written(1).value, value));
      end
    end
