...
classdef MockOptionalVectorsWriter < matlab.mixin.Copyable & test_model.OptionalVectorsWriterBase
  ...
  methods
    ...
    function expect_write_record_with_optional_vector_(obj, value)
      if isempty(obj.write_record_with_optional_vector_written)
        obj.write_record_with_optional_vector_written = Node(value);
      else
        last_dim = ndims(value);
        obj.write_record_with_optional_vector_written = Node(cat(last_dim, obj.write_record_with_optional_vector_written(1).value, value));
      end
    end
