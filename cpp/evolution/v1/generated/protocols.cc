...
bool ProtocolWithChangesIndexedReaderBase::ReadStreamIntToStringToFloat(std::string& value, size_t idx) {
  return ReadStreamIntToStringToFloatImpl(value, idx);
}

bool ProtocolWithChangesIndexedReaderBase::ReadStreamIntToStringToFloat(std::vector<std::string>& values, size_t idx) {
  if (values.capacity() == 0) {
    throw std::runtime_error("vector must have a nonzero capacity.");
  }
...
bool ProtocolWithChangesIndexedReaderBase::ReadStreamUnionReordered(std::variant<std::string, int32_t>& value, size_t idx) {
  return ReadStreamUnionReorderedImpl(value, idx);
}

bool ProtocolWithChangesIndexedReaderBase::ReadStreamUnionReordered(std::vector<std::variant<std::string, int32_t>>& values, size_t idx) {
  if (values.capacity() == 0) {
    throw std::runtime_error("vector must have a nonzero capacity.");
  }
...
bool ProtocolWithChangesIndexedReaderBase::ReadIntToUnionStream(int32_t& value, size_t idx) {
  return ReadIntToUnionStreamImpl(value, idx);
}

bool ProtocolWithChangesIndexedReaderBase::ReadIntToUnionStream(std::vector<int32_t>& values, size_t idx) {
  if (values.capacity() == 0) {
    throw std::runtime_error("vector must have a nonzero capacity.");
  }
...
bool ProtocolWithChangesIndexedReaderBase::ReadUnionStreamTypeChange(std::variant<int32_t, bool>& value, size_t idx) {
  return ReadUnionStreamTypeChangeImpl(value, idx);
}

bool ProtocolWithChangesIndexedReaderBase::ReadUnionStreamTypeChange(std::vector<std::variant<int32_t, bool>>& values, size_t idx) {
  if (values.capacity() == 0) {
    throw std::runtime_error("vector must have a nonzero capacity.");
  }
...
bool ProtocolWithChangesIndexedReaderBase::ReadGenericRecordStream(evo_test::AliasedClosedGenericRecord& value, size_t idx) {
  return ReadGenericRecordStreamImpl(value, idx);
}

bool ProtocolWithChangesIndexedReaderBase::ReadGenericRecordStream(std::vector<evo_test::AliasedClosedGenericRecord>& values, size_t idx) {
  if (values.capacity() == 0) {
    throw std::runtime_error("vector must have a nonzero capacity.");
  }
