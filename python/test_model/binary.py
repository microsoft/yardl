...
class BinaryBenchmarkSimpleMrdWriter(_binary.BinaryProtocolWriter, BenchmarkSimpleMrdWriterBase):
    ...
    def _write_data(self, value: collections.abc.Iterable[SimpleAcquisition | Image[yardl.Float32]]) -> None:
        _binary.StreamSerializer(_binary.UnionSerializer([(SimpleAcquisition, _SimpleAcquisitionSerializer()), (Image[yardl.Float32], _binary.NDArraySerializer(_binary.float32_serializer, 2))])).write(self._stream, value)
...
class BinaryBenchmarkSimpleMrdReader(_binary.BinaryProtocolReader, BenchmarkSimpleMrdReaderBase):
    ...
    def _read_data(self) -> collections.abc.Iterable[SimpleAcquisition | Image[yardl.Float32]]:
        return _binary.StreamSerializer(_binary.UnionSerializer([(SimpleAcquisition, _SimpleAcquisitionSerializer()), (Image[yardl.Float32], _binary.NDArraySerializer(_binary.float32_serializer, 2))])).read(self._stream, self._read_as_numpy)
...
class BinaryFixedArraysWriter(_binary.BinaryProtocolWriter, FixedArraysWriterBase):
    ...
    def _write_fixed_simple_record_array(self, value: npt.NDArray[np.void]) -> None:
        _binary.FixedNDArraySerializer(_SimpleRecord_NumpySerializer(), (3, 2,)).write(self._stream, value)

    def _write_fixed_record_with_vlens_array(self, value: npt.NDArray[np.void]) -> None:
        _binary.FixedNDArraySerializer(_RecordWithVlens_NumpySerializer(), (2, 2,)).write(self._stream, value)
...
class BinaryFixedArraysReader(_binary.BinaryProtocolReader, FixedArraysReaderBase):
    ...
    def _read_fixed_simple_record_array(self) -> npt.NDArray[np.void]:
        return _binary.FixedNDArraySerializer(_SimpleRecord_NumpySerializer(), (3, 2,)).read(self._stream, self._read_as_numpy)

    def _read_fixed_record_with_vlens_array(self) -> npt.NDArray[np.void]:
        return _binary.FixedNDArraySerializer(_RecordWithVlens_NumpySerializer(), (2, 2,)).read(self._stream, self._read_as_numpy)
...
class BinaryNDArraysWriter(_binary.BinaryProtocolWriter, NDArraysWriterBase):
    ...
    def _write_simple_record_array(self, value: npt.NDArray[np.void]) -> None:
        _binary.NDArraySerializer(_SimpleRecord_NumpySerializer(), 2).write(self._stream, value)

    def _write_record_with_vlens_array(self, value: npt.NDArray[np.void]) -> None:
        _binary.NDArraySerializer(_RecordWithVlens_NumpySerializer(), 2).write(self._stream, value)
...
class BinaryNDArraysReader(_binary.BinaryProtocolReader, NDArraysReaderBase):
    ...
    def _read_simple_record_array(self) -> npt.NDArray[np.void]:
        return _binary.NDArraySerializer(_SimpleRecord_NumpySerializer(), 2).read(self._stream, self._read_as_numpy)

    def _read_record_with_vlens_array(self) -> npt.NDArray[np.void]:
        return _binary.NDArraySerializer(_RecordWithVlens_NumpySerializer(), 2).read(self._stream, self._read_as_numpy)
...
class BinaryNDArraysSingleDimensionWriter(_binary.BinaryProtocolWriter, NDArraysSingleDimensionWriterBase):
    ...
    def _write_simple_record_array(self, value: npt.NDArray[np.void]) -> None:
        _binary.NDArraySerializer(_SimpleRecord_NumpySerializer(), 1).write(self._stream, value)

    def _write_record_with_vlens_array(self, value: npt.NDArray[np.void]) -> None:
        _binary.NDArraySerializer(_RecordWithVlens_NumpySerializer(), 1).write(self._stream, value)
...
class BinaryNDArraysSingleDimensionReader(_binary.BinaryProtocolReader, NDArraysSingleDimensionReaderBase):
    ...
    def _read_simple_record_array(self) -> npt.NDArray[np.void]:
        return _binary.NDArraySerializer(_SimpleRecord_NumpySerializer(), 1).read(self._stream, self._read_as_numpy)

    def _read_record_with_vlens_array(self) -> npt.NDArray[np.void]:
        return _binary.NDArraySerializer(_RecordWithVlens_NumpySerializer(), 1).read(self._stream, self._read_as_numpy)
...
class BinaryDynamicNDArraysWriter(_binary.BinaryProtocolWriter, DynamicNDArraysWriterBase):
    ...
    def _write_simple_record_array(self, value: npt.NDArray[np.void]) -> None:
        _binary.DynamicNDArraySerializer(_SimpleRecord_NumpySerializer()).write(self._stream, value)

    def _write_record_with_vlens_array(self, value: npt.NDArray[np.void]) -> None:
        _binary.DynamicNDArraySerializer(_RecordWithVlens_NumpySerializer()).write(self._stream, value)
...
class BinaryDynamicNDArraysReader(_binary.BinaryProtocolReader, DynamicNDArraysReaderBase):
    ...
    def _read_simple_record_array(self) -> npt.NDArray[np.void]:
        return _binary.DynamicNDArraySerializer(_SimpleRecord_NumpySerializer()).read(self._stream, self._read_as_numpy)

    def _read_record_with_vlens_array(self) -> npt.NDArray[np.void]:
        return _binary.DynamicNDArraySerializer(_RecordWithVlens_NumpySerializer()).read(self._stream, self._read_as_numpy)
...
class BinaryMapsWriter(_binary.BinaryProtocolWriter, MapsWriterBase):
    ...
    def _write_string_to_union(self, value: dict[str, str | yardl.Int32]) -> None:
        _binary.MapSerializer(_binary.string_serializer, _binary.UnionSerializer([(str, _binary.string_serializer), (yardl.Int32, _binary.int32_serializer)])).write(self._stream, value)
...
class BinaryMapsReader(_binary.BinaryProtocolReader, MapsReaderBase):
    ...
    def _read_string_to_union(self) -> dict[str, str | yardl.Int32]:
        return _binary.MapSerializer(_binary.string_serializer, _binary.UnionSerializer([(str, _binary.string_serializer), (yardl.Int32, _binary.int32_serializer)])).read(self._stream, self._read_as_numpy)
...
class BinaryUnionsWriter(_binary.BinaryProtocolWriter, UnionsWriterBase):
    ...
    def _write_int_or_simple_record(self, value: yardl.Int32 | SimpleRecord) -> None:
        _binary.UnionSerializer([(yardl.Int32, _binary.int32_serializer), (SimpleRecord, _SimpleRecordSerializer())]).write(self._stream, value)

    def _write_int_or_record_with_vlens(self, value: yardl.Int32 | RecordWithVlens) -> None:
        _binary.UnionSerializer([(yardl.Int32, _binary.int32_serializer), (RecordWithVlens, _RecordWithVlensSerializer())]).write(self._stream, value)

    def _write_monosotate_or_int_or_simple_record(self, value: yardl.Int32 | SimpleRecord | None) -> None:
        _binary.UnionSerializer([(None.__class__, _binary.none_serializer), (yardl.Int32, _binary.int32_serializer), (SimpleRecord, _SimpleRecordSerializer())]).write(self._stream, value)
...
class BinaryUnionsReader(_binary.BinaryProtocolReader, UnionsReaderBase):
    ...
    def _read_int_or_simple_record(self) -> yardl.Int32 | SimpleRecord:
        return _binary.UnionSerializer([(yardl.Int32, _binary.int32_serializer), (SimpleRecord, _SimpleRecordSerializer())]).read(self._stream, self._read_as_numpy)

    def _read_int_or_record_with_vlens(self) -> yardl.Int32 | RecordWithVlens:
        return _binary.UnionSerializer([(yardl.Int32, _binary.int32_serializer), (RecordWithVlens, _RecordWithVlensSerializer())]).read(self._stream, self._read_as_numpy)

    def _read_monosotate_or_int_or_simple_record(self) -> yardl.Int32 | SimpleRecord | None:
        return _binary.UnionSerializer([(None.__class__, _binary.none_serializer), (yardl.Int32, _binary.int32_serializer), (SimpleRecord, _SimpleRecordSerializer())]).read(self._stream, self._read_as_numpy)
...
class BinaryStreamsOfUnionsWriter(_binary.BinaryProtocolWriter, StreamsOfUnionsWriterBase):
    ...
    def _write_int_or_simple_record(self, value: collections.abc.Iterable[yardl.Int32 | SimpleRecord]) -> None:
        _binary.StreamSerializer(_binary.UnionSerializer([(yardl.Int32, _binary.int32_serializer), (SimpleRecord, _SimpleRecordSerializer())])).write(self._stream, value)

    def _write_nullable_int_or_simple_record(self, value: collections.abc.Iterable[yardl.Int32 | SimpleRecord | None]) -> None:
        _binary.StreamSerializer(_binary.UnionSerializer([(None.__class__, _binary.none_serializer), (yardl.Int32, _binary.int32_serializer), (SimpleRecord, _SimpleRecordSerializer())])).write(self._stream, value)
...
class BinaryStreamsOfUnionsReader(_binary.BinaryProtocolReader, StreamsOfUnionsReaderBase):
    ...
    def _read_int_or_simple_record(self) -> collections.abc.Iterable[yardl.Int32 | SimpleRecord]:
        return _binary.StreamSerializer(_binary.UnionSerializer([(yardl.Int32, _binary.int32_serializer), (SimpleRecord, _SimpleRecordSerializer())])).read(self._stream, self._read_as_numpy)

    def _read_nullable_int_or_simple_record(self) -> collections.abc.Iterable[yardl.Int32 | SimpleRecord | None]:
        return _binary.StreamSerializer(_binary.UnionSerializer([(None.__class__, _binary.none_serializer), (yardl.Int32, _binary.int32_serializer), (SimpleRecord, _SimpleRecordSerializer())])).read(self._stream, self._read_as_numpy)
...
class BinarySimpleGenericsWriter(_binary.BinaryProtocolWriter, SimpleGenericsWriterBase):
    ...
    def _write_float_image(self, value: Image[yardl.Float32]) -> None:
        _binary.NDArraySerializer(_binary.float32_serializer, 2).write(self._stream, value)

    def _write_int_image(self, value: Image[yardl.Int32]) -> None:
        _binary.NDArraySerializer(_binary.int32_serializer, 2).write(self._stream, value)

    def _write_int_image_alternate_syntax(self, value: Image[yardl.Int32]) -> None:
        _binary.NDArraySerializer(_binary.int32_serializer, 2).write(self._stream, value)

    def _write_string_image(self, value: Image[str]) -> None:
    ...
    def _write_stream_of_type_variants(self, value: collections.abc.Iterable[Image[yardl.Float32] | Image[yardl.Float64]]) -> None:
        _binary.StreamSerializer(_binary.UnionSerializer([(Image[yardl.Float32], _binary.NDArraySerializer(_binary.float32_serializer, 2)), (Image[yardl.Float64], _binary.NDArraySerializer(_binary.float64_serializer, 2))])).write(self._stream, value)
...
class BinarySimpleGenericsReader(_binary.BinaryProtocolReader, SimpleGenericsReaderBase):
    ...
    def _read_float_image(self) -> Image[yardl.Float32]:
        return _binary.NDArraySerializer(_binary.float32_serializer, 2).read(self._stream, self._read_as_numpy)

    def _read_int_image(self) -> Image[yardl.Int32]:
        return _binary.NDArraySerializer(_binary.int32_serializer, 2).read(self._stream, self._read_as_numpy)

    def _read_int_image_alternate_syntax(self) -> Image[yardl.Int32]:
        return _binary.NDArraySerializer(_binary.int32_serializer, 2).read(self._stream, self._read_as_numpy)

    def _read_string_image(self) -> Image[str]:
    ...
    def _read_stream_of_type_variants(self) -> collections.abc.Iterable[Image[yardl.Float32] | Image[yardl.Float64]]:
        return _binary.StreamSerializer(_binary.UnionSerializer([(Image[yardl.Float32], _binary.NDArraySerializer(_binary.float32_serializer, 2)), (Image[yardl.Float64], _binary.NDArraySerializer(_binary.float64_serializer, 2))])).read(self._stream, self._read_as_numpy)
...
class BinaryAdvancedGenericsWriter(_binary.BinaryProtocolWriter, AdvancedGenericsWriterBase):
    ...
    def _write_int_image_image(self, value: Image[Image[yardl.Float32]]) -> None:
        _binary.NDArraySerializer(_binary.NDArraySerializer(_binary.float32_serializer, 2), 2).write(self._stream, value)

    def _write_generic_record_1(self, value: GenericRecord[yardl.Int32, str]) -> None:
...
class BinaryAdvancedGenericsReader(_binary.BinaryProtocolReader, AdvancedGenericsReaderBase):
    ...
    def _read_int_image_image(self) -> Image[Image[yardl.Float32]]:
    ...
    def _read_generic_record_1(self) -> GenericRecord[yardl.Int32, str]:
...
class BinaryAliasesWriter(_binary.BinaryProtocolWriter, AliasesWriterBase):
    ...
    def _write_aliased_open_generic(self, value: AliasedOpenGeneric[AliasedString, AliasedEnum]) -> None:
        _MyTupleSerializer(_binary.string_serializer, _binary.EnumSerializer(_binary.int32_serializer, test_model.Fruits)).write(self._stream, value)
    ...
    def _write_aliased_generic_union_2(self, value: AliasedGenericUnion2[AliasedString, AliasedEnum]) -> None:
        _binary.UnionSerializer([(AliasedString, _binary.string_serializer), (AliasedEnum, _binary.EnumSerializer(_binary.int32_serializer, Fruits))]).write(self._stream, value)
    ...
    def _write_stream_of_aliased_generic_union_2(self, value: collections.abc.Iterable[AliasedGenericUnion2[AliasedString, AliasedEnum]]) -> None:
        _binary.StreamSerializer(_binary.UnionSerializer([(AliasedString, _binary.string_serializer), (AliasedEnum, _binary.EnumSerializer(_binary.int32_serializer, Fruits))])).write(self._stream, value)
...
class BinaryAliasesReader(_binary.BinaryProtocolReader, AliasesReaderBase):
    ...
    def _read_aliased_open_generic(self) -> AliasedOpenGeneric[AliasedString, AliasedEnum]:
        return _MyTupleSerializer(_binary.string_serializer, _binary.EnumSerializer(_binary.int32_serializer, test_model.Fruits)).read(self._stream, self._read_as_numpy)
    ...
    def _read_aliased_generic_union_2(self) -> AliasedGenericUnion2[AliasedString, AliasedEnum]:
        return _binary.UnionSerializer([(AliasedString, _binary.string_serializer), (AliasedEnum, _binary.EnumSerializer(_binary.int32_serializer, Fruits))]).read(self._stream, self._read_as_numpy)
    ...
    def _read_stream_of_aliased_generic_union_2(self) -> collections.abc.Iterable[AliasedGenericUnion2[AliasedString, AliasedEnum]]:
        return _binary.StreamSerializer(_binary.UnionSerializer([(AliasedString, _binary.string_serializer), (AliasedEnum, _binary.EnumSerializer(_binary.int32_serializer, Fruits))])).read(self._stream, self._read_as_numpy)
...
class _SmallBenchmarkRecord_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("a", _binary.float64_serializer), ("b", _binary.float32_serializer), ("c", _binary.float32_serializer)])
...
class _SimpleEncodingCounters_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("e1", _binary.OptionalSerializer(_binary.uint32_serializer)), ("e2", _binary.OptionalSerializer(_binary.uint32_serializer)), ("slice", _binary.OptionalSerializer(_binary.uint32_serializer)), ("repetition", _binary.OptionalSerializer(_binary.uint32_serializer))])
...
class _SimpleAcquisition_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("flags", _binary.uint64_serializer), ("idx", _SimpleEncodingCounters_NumpySerializer()), ("data", _binary.NDArraySerializer(_binary.complexfloat32_serializer, 2)), ("trajectory", _binary.NDArraySerializer(_binary.float32_serializer, 2))])
...
class _SimpleRecord_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("x", _binary.int32_serializer), ("y", _binary.int32_serializer), ("z", _binary.int32_serializer)])
...
class _RecordWithPrimitives_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("bool_field", _binary.bool_serializer), ("int_8_field", _binary.int8_serializer), ("uint_8_field", _binary.uint8_serializer), ("int_16_field", _binary.int16_serializer), ("uint_16_field", _binary.uint16_serializer), ("int_32_field", _binary.int32_serializer), ("uint_32_field", _binary.uint32_serializer), ("int_64_field", _binary.int64_serializer), ("uint_64_field", _binary.uint64_serializer), ("size_field", _binary.size_serializer), ("float_32_field", _binary.float32_serializer), ("float_64_field", _binary.float64_serializer), ("complexfloat_32_field", _binary.complexfloat32_serializer), ("complexfloat_64_field", _binary.complexfloat64_serializer), ("date_field", _binary.date_serializer), ("time_field", _binary.time_serializer), ("datetime_field", _binary.datetime_serializer)])
...
class _RecordWithPrimitiveAliases_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("byte_field", _binary.uint8_serializer), ("int_field", _binary.int32_serializer), ("uint_field", _binary.uint32_serializer), ("long_field", _binary.int64_serializer), ("ulong_field", _binary.uint64_serializer), ("float_field", _binary.float32_serializer), ("double_field", _binary.float64_serializer), ("complexfloat_field", _binary.complexfloat32_serializer), ("complexdouble_field", _binary.complexfloat64_serializer)])
...
class _TupleWithRecords_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("a", _SimpleRecord_NumpySerializer()), ("b", _SimpleRecord_NumpySerializer())])
...
class _RecordWithVectors_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("default_vector", _binary.VectorSerializer(_binary.int32_serializer)), ("default_vector_fixed_length", _binary.FixedVectorSerializer(_binary.int32_serializer, 3)), ("vector_of_vectors", _binary.VectorSerializer(_binary.FixedVectorSerializer(_binary.int32_serializer, 2)))])
...
class _RecordWithArrays_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("default_array", _binary.DynamicNDArraySerializer(_binary.int32_serializer)), ("default_array_with_empty_dimension", _binary.DynamicNDArraySerializer(_binary.int32_serializer)), ("rank_1_array", _binary.NDArraySerializer(_binary.int32_serializer, 1)), ("rank_2_array", _binary.NDArraySerializer(_binary.int32_serializer, 2)), ("rank_2_array_with_named_dimensions", _binary.NDArraySerializer(_binary.int32_serializer, 2)), ("rank_2_fixed_array", _binary.FixedNDArraySerializer(_binary.int32_serializer, (3, 4,))), ("rank_2_fixed_array_with_named_dimensions", _binary.FixedNDArraySerializer(_binary.int32_serializer, (3, 4,))), ("dynamic_array", _binary.DynamicNDArraySerializer(_binary.int32_serializer)), ("array_of_vectors", _binary.FixedNDArraySerializer(_binary.FixedVectorSerializer(_binary.int32_serializer, 4), (5,)))])
...
class _RecordWithArraysSimpleSyntax_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("default_array", _binary.DynamicNDArraySerializer(_binary.int32_serializer)), ("default_array_with_empty_dimension", _binary.DynamicNDArraySerializer(_binary.int32_serializer)), ("rank_1_array", _binary.NDArraySerializer(_binary.int32_serializer, 1)), ("rank_2_array", _binary.NDArraySerializer(_binary.int32_serializer, 2)), ("rank_2_array_with_named_dimensions", _binary.NDArraySerializer(_binary.int32_serializer, 2)), ("rank_2_fixed_array", _binary.FixedNDArraySerializer(_binary.int32_serializer, (3, 4,))), ("rank_2_fixed_array_with_named_dimensions", _binary.FixedNDArraySerializer(_binary.int32_serializer, (3, 4,))), ("dynamic_array", _binary.DynamicNDArraySerializer(_binary.int32_serializer)), ("array_of_vectors", _binary.FixedNDArraySerializer(_binary.FixedVectorSerializer(_binary.int32_serializer, 4), (5,)))])
...
class _RecordWithOptionalFields_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("optional_int", _binary.OptionalSerializer(_binary.int32_serializer)), ("optional_int_alternate_syntax", _binary.OptionalSerializer(_binary.int32_serializer))])
...
class _RecordWithVlens_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("a", _binary.VectorSerializer(_SimpleRecord_NumpySerializer())), ("b", _binary.int32_serializer), ("c", _binary.int32_serializer)])
...
class _RecordWithStrings_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("a", _binary.string_serializer), ("b", _binary.string_serializer)])
...
class _RecordWithOptionalVector_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("optional_vector", _binary.OptionalSerializer(_binary.VectorSerializer(_binary.int32_serializer)))])
...
class _RecordWithFixedVectors_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("fixed_int_vector", _binary.FixedVectorSerializer(_binary.int32_serializer, 5)), ("fixed_simple_record_vector", _binary.FixedVectorSerializer(_SimpleRecord_NumpySerializer(), 3)), ("fixed_record_with_vlens_vector", _binary.FixedVectorSerializer(_RecordWithVlens_NumpySerializer(), 2))])
...
class _RecordWithFixedArraysSerializer(_binary.RecordSerializer[RecordWithFixedArrays]):
    def __init__(self) -> None:
        super().__init__([("ints", _binary.FixedNDArraySerializer(_binary.int32_serializer, (2, 3,))), ("fixed_simple_record_array", _binary.FixedNDArraySerializer(_SimpleRecord_NumpySerializer(), (3, 2,))), ("fixed_record_with_vlens_array", _binary.FixedNDArraySerializer(_RecordWithVlens_NumpySerializer(), (2, 2,)))])
...
class _RecordWithFixedArrays_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("ints", _binary.FixedNDArraySerializer(_binary.int32_serializer, (2, 3,))), ("fixed_simple_record_array", _binary.FixedNDArraySerializer(_SimpleRecord_NumpySerializer(), (3, 2,))), ("fixed_record_with_vlens_array", _binary.FixedNDArraySerializer(_RecordWithVlens_NumpySerializer(), (2, 2,)))])
...
class _RecordWithNDArraysSerializer(_binary.RecordSerializer[RecordWithNDArrays]):
    def __init__(self) -> None:
        super().__init__([("ints", _binary.NDArraySerializer(_binary.int32_serializer, 2)), ("fixed_simple_record_array", _binary.NDArraySerializer(_SimpleRecord_NumpySerializer(), 2)), ("fixed_record_with_vlens_array", _binary.NDArraySerializer(_RecordWithVlens_NumpySerializer(), 2))])
...
class _RecordWithNDArrays_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("ints", _binary.NDArraySerializer(_binary.int32_serializer, 2)), ("fixed_simple_record_array", _binary.NDArraySerializer(_SimpleRecord_NumpySerializer(), 2)), ("fixed_record_with_vlens_array", _binary.NDArraySerializer(_RecordWithVlens_NumpySerializer(), 2))])
...
class _RecordWithNDArraysSingleDimensionSerializer(_binary.RecordSerializer[RecordWithNDArraysSingleDimension]):
    def __init__(self) -> None:
        super().__init__([("ints", _binary.NDArraySerializer(_binary.int32_serializer, 1)), ("fixed_simple_record_array", _binary.NDArraySerializer(_SimpleRecord_NumpySerializer(), 1)), ("fixed_record_with_vlens_array", _binary.NDArraySerializer(_RecordWithVlens_NumpySerializer(), 1))])
...
class _RecordWithNDArraysSingleDimension_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("ints", _binary.NDArraySerializer(_binary.int32_serializer, 1)), ("fixed_simple_record_array", _binary.NDArraySerializer(_SimpleRecord_NumpySerializer(), 1)), ("fixed_record_with_vlens_array", _binary.NDArraySerializer(_RecordWithVlens_NumpySerializer(), 1))])
...
class _RecordWithDynamicNDArraysSerializer(_binary.RecordSerializer[RecordWithDynamicNDArrays]):
    def __init__(self) -> None:
        super().__init__([("ints", _binary.DynamicNDArraySerializer(_binary.int32_serializer)), ("fixed_simple_record_array", _binary.DynamicNDArraySerializer(_SimpleRecord_NumpySerializer())), ("fixed_record_with_vlens_array", _binary.DynamicNDArraySerializer(_RecordWithVlens_NumpySerializer()))])
...
class _RecordWithDynamicNDArrays_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("ints", _binary.DynamicNDArraySerializer(_binary.int32_serializer)), ("fixed_simple_record_array", _binary.DynamicNDArraySerializer(_SimpleRecord_NumpySerializer())), ("fixed_record_with_vlens_array", _binary.DynamicNDArraySerializer(_RecordWithVlens_NumpySerializer()))])
...
class _RecordWithUnionsSerializer(_binary.RecordSerializer[RecordWithUnions]):
    def __init__(self) -> None:
        super().__init__([("null_or_int_or_string", _binary.UnionSerializer([(None.__class__, _binary.none_serializer), (yardl.Int32, _binary.int32_serializer), (str, _binary.string_serializer)]))])
...
class _RecordWithUnions_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("null_or_int_or_string", _binary.UnionSerializer([(None.__class__, _binary.none_serializer), (yardl.Int32, _binary.int32_serializer), (str, _binary.string_serializer)]))])
...
class _GenericRecordSerializer(_binary.RecordSerializer[GenericRecord[T1, T2]]):
    def __init__(self, t1_serializer: _binary.TypeSerializer[T1], t2_serializer: _binary.TypeSerializer[T2]) -> None:
    ...
    def write(self, stream: _binary.CodedOutputStream, value: GenericRecord[T1, T2]) -> None:
        self._write(stream, value.scalar_1, value.scalar_2, value.vector_1, value.image_2)

    def read(self, stream: _binary.CodedInputStream, read_as_numpy: Types) -> GenericRecord[T1, T2]:
        field_values = self._read(stream, read_as_numpy)
        return GenericRecord[T1, T2](scalar_1=field_values[0], scalar_2=field_values[1], vector_1=field_values[2], image_2=field_values[3])


class _GenericRecord_NumpySerializer(typing.Generic[T1, T2], _binary.RecordSerializer[typing.Any]):
    def __init__(self, t1_serializer: _binary.TypeSerializer[T1], t2_serializer: _binary.TypeSerializer[T2]) -> None:
        super().__init__([("scalar_1", t1_serializer), ("scalar_2", t2_serializer), ("vector_1", _binary.VectorSerializer(t1_serializer)), ("image_2", _binary.NDArraySerializer(t2_serializer, 2))])
...
class _MyTupleSerializer(_binary.RecordSerializer[MyTuple[T1, T2]]):
    def __init__(self, t1_serializer: _binary.TypeSerializer[T1], t2_serializer: _binary.TypeSerializer[T2]) -> None:
...
class _MyTuple_NumpySerializer(typing.Generic[T1, T2], _binary.RecordSerializer[typing.Any]):
    def __init__(self, t1_serializer: _binary.TypeSerializer[T1], t2_serializer: _binary.TypeSerializer[T2]) -> None:
        super().__init__([("v1", t1_serializer), ("v2", t2_serializer)])
...
class _GenericRecordWithComputedFieldsSerializer(_binary.RecordSerializer[GenericRecordWithComputedFields[T0, T1]]):
    def __init__(self, t0_serializer: _binary.TypeSerializer[T0], t1_serializer: _binary.TypeSerializer[T1]) -> None:
...
class _GenericRecordWithComputedFields_NumpySerializer(typing.Generic[T0, T1], _binary.RecordSerializer[typing.Any]):
    def __init__(self, t0_serializer: _binary.TypeSerializer[T0], t1_serializer: _binary.TypeSerializer[T1]) -> None:
        super().__init__([("f1", _binary.UnionSerializer([(T0, t0_serializer), (T1, t1_serializer)]))])
...
class _RecordWithComputedFields_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("array_field", _binary.NDArraySerializer(_binary.int32_serializer, 2)), ("array_field_map_dimensions", _binary.NDArraySerializer(_binary.int32_serializer, 2)), ("dynamic_array_field", _binary.DynamicNDArraySerializer(_binary.int32_serializer)), ("fixed_array_field", _binary.FixedNDArraySerializer(_binary.int32_serializer, (3, 4,))), ("int_field", _binary.int32_serializer), ("string_field", _binary.string_serializer), ("tuple_field", _MyTuple_NumpySerializer(_binary.int32_serializer, _binary.int32_serializer)), ("vector_field", _binary.VectorSerializer(_binary.int32_serializer)), ("vector_of_vectors_field", _binary.VectorSerializer(_binary.VectorSerializer(_binary.int32_serializer))), ("fixed_vector_field", _binary.FixedVectorSerializer(_binary.int32_serializer, 3)), ("optional_named_array", _binary.OptionalSerializer(_binary.NDArraySerializer(_binary.int32_serializer, 2))), ("int_float_union", _binary.UnionSerializer([(yardl.Int32, _binary.int32_serializer), (yardl.Float32, _binary.float32_serializer)])), ("nullable_int_float_union", _binary.UnionSerializer([(None.__class__, _binary.none_serializer), (yardl.Int32, _binary.int32_serializer), (yardl.Float32, _binary.float32_serializer)])), ("union_with_nested_generic_union", _binary.UnionSerializer([(yardl.Int32, _binary.int32_serializer), (GenericRecordWithComputedFields[str, yardl.Float32], _GenericRecordWithComputedFields_NumpySerializer(_binary.string_serializer, _binary.float32_serializer))])), ("map_field", _binary.MapSerializer(_binary.string_serializer, _binary.string_serializer))])
...
class _RecordWithKeywordFields_NumpySerializer(_binary.RecordSerializer[typing.Any]):
    def __init__(self) -> None:
        super().__init__([("int_", _binary.string_serializer), ("sizeof", _binary.NDArraySerializer(_binary.int32_serializer, 2)), ("if_", _binary.EnumSerializer(_binary.int32_serializer, EnumWithKeywordSymbols))])
