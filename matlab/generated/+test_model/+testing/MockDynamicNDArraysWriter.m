...
classdef MockDynamicNDArraysWriter < matlab.mixin.Copyable & test_model.DynamicNDArraysWriterBase
  ...
  methods
    function obj = MockDynamicNDArraysWriter(testCase)
      ...
      obj.expected_record_with_dynamic_nd_arrays = yardl.None;
    end
    ...
    function expect_write_record_with_dynamic_nd_arrays_(obj, value)
      obj.expected_record_with_dynamic_nd_arrays = yardl.Optional(value);
    end
    ...
    function verify(obj)
      ...
      obj.testCase_.verifyEqual(obj.expected_record_with_dynamic_nd_arrays, yardl.None, "Expected call to write_record_with_dynamic_nd_arrays_ was not received");
    end
  end
  ...
  methods (Access=protected)
    ...
    function write_record_with_dynamic_nd_arrays_(obj, value)
      obj.testCase_.verifyTrue(obj.expected_record_with_dynamic_nd_arrays.has_value(), "Unexpected call to write_record_with_dynamic_nd_arrays_");
      obj.testCase_.verifyEqual(value, obj.expected_record_with_dynamic_nd_arrays.value, "Unexpected argument value for call to write_record_with_dynamic_nd_arrays_");
      obj.expected_record_with_dynamic_nd_arrays = yardl.None;
    end
