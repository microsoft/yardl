classdef TestStreamsOfAliasedUnionsWriter < test_model.StreamsOfAliasedUnionsWriterBase
  ...
  methods
    function obj = TestStreamsOfAliasedUnionsWriter(testCase, writer, create_reader)
      obj.writer_ = writer;
      obj.create_reader_ = create_reader;
      obj.mock_writer_ = test_model.testing.MockStreamsOfAliasedUnionsWriter(testCase);
