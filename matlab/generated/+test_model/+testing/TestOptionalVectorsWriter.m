...
classdef TestOptionalVectorsWriter < test_model.OptionalVectorsWriterBase
  ...
  methods
    function self = TestOptionalVectorsWriter(testCase, format, create_writer, create_reader)
      self.filename_ = tempname();
      self.format_ = format;
      self.writer_ = create_writer(self.filename_);
      self.create_reader_ = create_reader;
      self.mock_writer_ = test_model.testing.MockOptionalVectorsWriter(testCase);
  ...
  methods (Access=protected)
    function write_record_with_optional_vector_(self, value)
      self.writer_.write_record_with_optional_vector(value);
      self.mock_writer_.expect_write_record_with_optional_vector_(value);
    end
