...
class ProtocolWithChangesWriterBase {
  ...
  void WriteStreamIntToStringToFloat(int32_t const& value);
  ...
  void WriteStreamIntToStringToFloat(std::vector<int32_t> const& values);

  // Marks the end of the `streamIntToStringToFloat` stream.
  void EndStreamIntToStringToFloat();

  // Ordinal 41.
  void WriteVectorIntToStringToFloat(std::vector<int32_t> const& value);
  ...
  virtual void WriteStreamIntToStringToFloatImpl(int32_t const& value) = 0;
  virtual void WriteStreamIntToStringToFloatImpl(std::vector<int32_t> const& value);
  virtual void EndStreamIntToStringToFloatImpl() = 0;
  virtual void WriteVectorIntToStringToFloatImpl(std::vector<int32_t> const& value) = 0;
...
class ProtocolWithChangesReaderBase {
  ...
  // Ordinal 40.
  // Stream and Vector type changes
  [[nodiscard]] bool ReadStreamIntToStringToFloat(int32_t& value);

  // Ordinal 40.
  // Stream and Vector type changes
  [[nodiscard]] bool ReadStreamIntToStringToFloat(std::vector<int32_t>& values);

  // Ordinal 41.
  void ReadVectorIntToStringToFloat(std::vector<int32_t>& value);
  ...
  void CopyTo(ProtocolWithChangesWriterBase& writer, size_t stream_int_to_string_to_float_buffer_size = 1, size_t stream_union_reordered_buffer_size = 1, size_t stream_of_alias_type_change_buffer_size = 1, size_t generic_record_stream_buffer_size = 1, size_t generic_parent_record_stream_buffer_size = 1, size_t streamed_record_with_changes_buffer_size = 1);
  ...
  virtual bool ReadStreamIntToStringToFloatImpl(int32_t& value) = 0;
  virtual bool ReadStreamIntToStringToFloatImpl(std::vector<int32_t>& values);
  virtual void ReadVectorIntToStringToFloatImpl(std::vector<int32_t>& value) = 0;
